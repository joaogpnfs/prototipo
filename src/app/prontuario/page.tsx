          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                abdominal há 3 dias. Tutor relata que iniciou após passeio em
                área com grama alta. Sem alterações no apetite ou comportamento.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Dermatite alérgica, possivelmente causada por contato com
                alérgeno ambiental (gramíneas).
              </p>
            </div>
