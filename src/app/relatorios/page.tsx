          ...
          <Card className="max-w-md w-full">
            <CardContent className="pt-6 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Estamos desenvolvendo um sistema completo de relatórios e
                análises para ajudar você a tomar decisões baseadas em dados. Em
                breve você terá acesso a gráficos, estatísticas e insights
                valiosos sobre sua clínica.
              </p>
